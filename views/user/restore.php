                ...
                <div class="row">
                    ...
                    <div class="col-lg-12" style="margin-bottom: 50px;">
                        <div class="content__main-wrapper">
                                ...
                                <form class="form-horizontal" role="form" method="POST" action="/restore">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <?php if ($result): ?>
                                                ...
                                                <div class="alert alert-success">
                                                   Одноразовый пароль отправлен на почту - <?= $email ?>;
                                                </div>
                                            <?php endif ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <button type="submit" name="restore" class="btn btn-success">Далее</button>
                                        </div>
                                    </div>
                                </form>
                        </div>
